...
- [ ] RULED 2026-09-12: BRIAN SOTO LANDSCAPING INC.'s contact record waits; provenance reported first, Brian rules whether it is a different person (note) or a migration artifact.
...
- [ ] 2. Merge the Zoho brian3712@gmail.com record into brian@sotoaccounting.com (two records, one winner); list everything moved by name before and after. GORDEETAH LLC is Brian's and dissolved: status dissolved on the winner.
