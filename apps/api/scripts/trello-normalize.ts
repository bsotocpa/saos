...
export interface StageMapping {
   ...
   *
   *   'declare_and_confirm'  jurisdictions from the R2 default, method by the year's lane (R31), flagged as a default
